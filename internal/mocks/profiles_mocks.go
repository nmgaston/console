...
func (mr *MockProfilesRepositoryMockRecorder) Delete(ctx, profileName, tenantID interface{}) *gomock.Call {
...
func (mr *MockProfilesRepositoryMockRecorder) Get(ctx, top, skip, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfilesRepositoryMockRecorder) GetByName(ctx, profileName, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfilesRepositoryMockRecorder) GetCount(ctx, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfilesRepositoryMockRecorder) Insert(ctx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfilesRepositoryMockRecorder) Update(ctx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockProfilesFeatureMockRecorder) Delete(ctx, profileName, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfilesFeatureMockRecorder) Export(ctx, profileName, domainName, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProfilesFeature) Get(ctx context.Context, top, skip int, tenantID string) ([]v1.Profile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, top, skip, tenantID)
...
// Get indicates an expected call of Get.
func (mr *MockProfilesFeatureMockRecorder) Get(ctx, top, skip, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetByName mocks base method.
func (m *MockProfilesFeature) GetByName(ctx context.Context, profileName, tenantID string) (*v1.Profile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByName", ctx, profileName, tenantID)
	ret0, _ := ret[0].(*v1.Profile)
	ret1, _ := ret[1].(error)
...
// GetByName indicates an expected call of GetByName.
func (mr *MockProfilesFeatureMockRecorder) GetByName(ctx, profileName, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetCount indicates an expected call of GetCount.
func (mr *MockProfilesFeatureMockRecorder) GetCount(ctx, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Insert mocks base method.
func (m *MockProfilesFeature) Insert(ctx context.Context, p *v1.Profile) (*v1.Profile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Insert", ctx, p)
	ret0, _ := ret[0].(*v1.Profile)
	ret1, _ := ret[1].(error)
...
// Insert indicates an expected call of Insert.
func (mr *MockProfilesFeatureMockRecorder) Insert(ctx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Insert", reflect.TypeOf((*MockProfilesFeature)(nil).Insert), ctx, p)
}

// Update mocks base method.
func (m *MockProfilesFeature) Update(ctx context.Context, p *v1.Profile) (*v1.Profile, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, p)
	ret0, _ := ret[0].(*v1.Profile)
	ret1, _ := ret[1].(error)
...
// Update indicates an expected call of Update.
func (mr *MockProfilesFeatureMockRecorder) Update(ctx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
