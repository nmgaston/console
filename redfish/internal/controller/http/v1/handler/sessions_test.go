...
func setupTestEnvironment() (*gin.Engine, *SessionHandler, *config.Config) {
...
func TestSessionServiceEndpoint(t *testing.T) {
	...
	assert.True(t, resp["ServiceEnabled"].(bool))
}
