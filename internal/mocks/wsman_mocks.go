...
func (mr *MockManagementMockRecorder) AddClientCert(clientCert interface{}) *gomock.Call {
...
func (mr *MockManagementMockRecorder) AddTrustedRootCert(caCert interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) BootServiceStateChange(requestedState interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) ChangeBootOrder(bootSource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) CreateAlarmOccurrences(name, startTime, interval, deleteOnCompletion interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) DeleteAlarmOccurrences(instanceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) DeleteCertificate(instanceID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) GetAuditLog(startIndex interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockManagement) GetDiskInfo() (interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) GetEventLog(startIndex, maxReadRecords interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockManagement) GetGeneralSettings() (interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockManagement) GetHardwareInfo() (interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) RequestAMTRedirectionServiceStateChange(ider, sol interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SendConsentCode(code interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SendPowerAction(action interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetAMTRedirectionService(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockManagement) SetBootConfigRole(role int) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetBootConfigRole(role interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockManagement) SetBootData(data boot.BootSettingDataRequest) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetBootData(data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetIPSKVMRedirectionSettingData(data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetIPSOptInService(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetKVMRedirection(enable interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagementMockRecorder) SetLinkPreference(linkPreference, timeout interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
