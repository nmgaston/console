...
func (siw *ServerInterfaceWrapper) GetRedfishV1ChassisChassisId(c *gin.Context) {
	...
	err = runtime.BindStyledParameter("simple", false, "ChassisId", c.Param("ChassisId"), &chassisId)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetRedfishV1ManagersManagerId(c *gin.Context) {
	...
	err = runtime.BindStyledParameter("simple", false, "ManagerId", c.Param("ManagerId"), &managerId)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetRedfishV1SystemsComputerSystemId(c *gin.Context) {
	...
	err = runtime.BindStyledParameter("simple", false, "ComputerSystemId", c.Param("ComputerSystemId"), &computerSystemId)
	if err != nil {
