...
func (m *MockAMTExplorerFeature) ExecuteCall(ctx context.Context, guid, call, tenantID string) (*v1.Explorer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteCall", ctx, guid, call, tenantID)
	ret0, _ := ret[0].(*v1.Explorer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ExecuteCall indicates an expected call of ExecuteCall.
func (mr *MockAMTExplorerFeatureMockRecorder) ExecuteCall(ctx, guid, call, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAMTExplorerRepositoryMockRecorder) GetByID(ctx, guid, tenantID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAMTExplorerWSMAN) DestroyWsmanClient(device v1.Device) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "DestroyWsmanClient", device)
}

// DestroyWsmanClient indicates an expected call of DestroyWsmanClient.
func (mr *MockAMTExplorerWSMANMockRecorder) DestroyWsmanClient(device interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAMTExplorerWSMAN) SetupWsmanClient(device entity.Device, logMessages bool) (amtexplorer.AMTExplorer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAMTExplorerWSMANMockRecorder) SetupWsmanClient(device, logMessages interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
