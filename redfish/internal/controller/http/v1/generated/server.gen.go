...
type PatchRedfishV1SystemsComputerSystemId204ResponseHeaders struct {
	Location string
}

type PatchRedfishV1SystemsComputerSystemId204Response struct {
	Headers PatchRedfishV1SystemsComputerSystemId204ResponseHeaders
}
...
type PatchRedfishV1SystemsComputerSystemId400JSONResponse RedfishError

func (response PatchRedfishV1SystemsComputerSystemId400JSONResponse) VisitPatchRedfishV1SystemsComputerSystemIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type PatchRedfishV1SystemsComputerSystemId404JSONResponse RedfishError

func (response PatchRedfishV1SystemsComputerSystemId404JSONResponse) VisitPatchRedfishV1SystemsComputerSystemIdResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
